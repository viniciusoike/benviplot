...
- Revised the README, vignette, and function reference for clearer API descriptions, accurate font guidance, consistent examples, and explicit UTF-8 metadata.
