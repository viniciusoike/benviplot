...
discontinued brand of the Brazilian proptech QuintoAndar[^1]. The
package ships with a custom ggplot2 theme, a family of discrete and
continuous color scales, and convenience wrappers for common chart
types.
