...
- **Set Palettes** (Set0-Set7): 4-color palettes for basic visualizations
- **Qualitative Palettes** (Qual1-Qual9): 8-color palettes for categorical data
- **Sequential Palettes** (Seq0-Seq7): 9-color gradients for continuous data
- **City-specific**: Special palettes for São Paulo, Rio, and Belo Horizonte
- **Index Colors**: Specialized color scales (index_blue, index_prpl)

View all available palettes by calling `benvi_palette()` with different palette names.
