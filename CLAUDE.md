...
Optional system-wide installation from Google Fonts; not needed since
Poppins is bundled with the package -
...
**R/plot_scatter.R** also exports: - `plot_add_xy()`: Helper to add axis
lines to a plot
